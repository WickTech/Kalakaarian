...
export default function ContactPage() {
  ...
  return (
    <main className="relative min-h-screen bg-gradient-to-b from-background to-muted/30 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-r from-purple-600/10 via-fuchsia-600/10 to-pink-600/10 pointer-events-none" />
      ...
      {/* Hero */}
      <div className="relative border-b border-white/5 px-4 py-14 text-center">
